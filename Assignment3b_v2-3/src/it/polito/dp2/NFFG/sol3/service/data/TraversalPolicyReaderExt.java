...
public class TraversalPolicyReaderExt extends PolicyReaderExt implements TraversalPolicyReader {
	...
	public TraversalPolicyReaderExt(PolicyType p, NffgReader e) throws NffgVerifierException {
	...
	private void init() {
		...
		for(it.polito.dp2.NFFG.sol3.jaxb.FunctionalType ft :((TraversalPolicyType)this.entity).getTraversedFTypes().getFType())
