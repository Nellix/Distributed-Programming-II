...
import it.polito.dp2.NFFG.sol1.jaxb.FunctionalType;
...
public class NffgInfoSerializer {
	...
	public static void main(String[] args) 
	{
		try {
			...
			System.err.println("[Serializer]Could not instantiate data generator.");
			e.printStackTrace();
		}
