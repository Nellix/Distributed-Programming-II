...
//	@Consumes({MediaType.APPLICATION_XML})
	@Produces({MediaType.APPLICATION_XML})
	public JAXBElement<VerificationResultType> testReachabilityPolicy(@PathParam("name") String name) throws NoGraphException, it.polito.dp2.NFFG.lab3.ServiceException {
	...
	public JAXBElement<ReachabilityPolicyType> deletePolicy(@PathParam("name") String policyName) {
		...
		PolicyType pol;
		synchronized (service.getALLPolicies()) {
