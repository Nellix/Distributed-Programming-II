...
package it.polito.dp2.NFFG.sol3.service.jaxrs;
...
}, comments = "wadl2java, http://wadl.java.net", date = "2017-02-18T00:53:59.761+01:00")
public class Localhost_Neo4JXMLRest {
    ...
    public static class Resource {
        ...
        public static class Node {
            ...
            public it.polito.dp2.NFFG.sol3.service.jaxrs.Node postXmlAsNode(it.polito.dp2.NFFG.sol3.service.jaxrs.Node input) {
                ...
                return response.getEntity(it.polito.dp2.NFFG.sol3.service.jaxrs.Node.class);
            }
        ...
        public static class NodeNodeid {
            ...
            public it.polito.dp2.NFFG.sol3.service.jaxrs.Node getAsNode() {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("application/xml");
        ...
        public static class NodeNodeidRelationship {
            ...
            public it.polito.dp2.NFFG.sol3.service.jaxrs.Relationship postXmlAsRelationship(it.polito.dp2.NFFG.sol3.service.jaxrs.Relationship input) {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("application/xml");
                ...
                return response.getEntity(it.polito.dp2.NFFG.sol3.service.jaxrs.Relationship.class);
            }
        ...
        public static class Nodes {
            ...
            public it.polito.dp2.NFFG.sol3.service.jaxrs.Nodes getAsNodes() {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("application/xml");
                ...
                return response.getEntity(it.polito.dp2.NFFG.sol3.service.jaxrs.Nodes.class);
            }
        ...
        public static class RelationshipRelationshipid {
            ...
            public it.polito.dp2.NFFG.sol3.service.jaxrs.Relationship getAsRelationship() {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("application/xml");
