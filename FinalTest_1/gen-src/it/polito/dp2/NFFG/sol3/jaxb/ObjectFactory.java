...
public class ObjectFactory {
    ...
    private final static QName _Cache_QNAME = new QName("http://www.example.org/nffgVerifier", "Cache");
    ...
    /**
     * Create an instance of {@link CachingType }
     * 
     */
    public CachingType createCachingType() {
        return new CachingType();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link CachingType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.example.org/nffgVerifier", name = "Cache")
    public JAXBElement<CachingType> createCache(CachingType value) {
        return new JAXBElement<CachingType>(_Cache_QNAME, CachingType.class, null, value);
    }
